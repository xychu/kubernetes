...
var map_PodSpec = map[string]string{
	...
	"preemptionPolicy":              "PreemptionPolicy is the Policy for pod preemption. One of Never, PreemptLowerPriority, NonPreemptible, NeverPreemptNonPreemptible. Defaults to PreemptLowerPriority if unset. This field is alpha-level and is only honored by servers that enable the NonPreemptingPriority feature.",
}
